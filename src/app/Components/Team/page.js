...
const TeamSection = () => {
  ...
  return (
    <div>
      {/* Heading section */}
      <div className="relative w-full h-[280px] sm:h-[320px] bg-gradient-to-r from-blue-800 to-purple-900 flex items-center justify-center text-white text-center px-4">
      ...
      {/* Leadership Team */}
      <div className="mt-12">
        <h2 className="text-3xl font-bold text-gray-700 text-center mb-8">Leadership Team</h2>
          ...
          {leadershipTeam.map((member, index) => (
            ...
            >
              ...
              <div className="gap-4">
                ...
                <p className="text-gray-500 mt-2 text-sm hidden sm:block">{member.description}</p>
      ...
      {/* Technical Team */}
      <div className="mt-12">
        <h2 className="text-3xl font-bold text-gray-700 text-center mb-8">Technical Team</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 px-16 py-8 gap-8">
