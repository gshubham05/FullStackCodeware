...
import { UserCheck, Users, Laptop, ClipboardCheck, HelpCircle, Briefcase } from "lucide-react";
...
export default function About() {
  return (
    <div className="">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-24 text-center shadow-lg">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold drop-shadow-lg">About Us</h1>
      ...
      <div className="flex flex-col-reverse lg:flex-row-reverse items-center mt-20 lg:mt-40 gap-10 lg:gap-40 px-6 lg:px-20">
        ...
        <div className="max-w-lg text-center lg:text-left">
          <h1 className="font-bold  sm:text-2xl mb-4 text-2xl">About Codeware Private Ltd</h1>
          <p className="text-gray-800 text-sm sm:text-lg leading-relaxed">
            Founded on <strong>March 2, 2023</strong>, in <strong>Dehradun</strong>,  
            <strong> Codeware Private Ltd</strong> was established under the  
            visionary leadership of <strong>Shubham Goyal</strong>. With a strong commitment  
            to excellence, the company specializes in <strong>training</strong>, delivering  
            innovative solutions tailored to meet the evolving needs of clients. Guided  
            by a mission to drive growth and innovation, <strong>Shubham Goyal</strong> and his  
            team work tirelessly to provide high-quality products and services while  
            fostering long-term partnerships. As a forward-thinking organization,  
            the company continues to expand its presence, ensuring customer satisfaction  
    ...
    <div className="py-20 bg-gradient-to-b from-blue-50 to-white sm:mt-[5rem] mt-[3rem]">
      <div className="max-w-6xl mx-auto px-6 text-center">
        {/* Section Heading */}
        <h2 className="text-5xl font-extrabold text-gray-900 mb-6">Our Mission & Values</h2>
        <p className="text-lg text-gray-700 mb-12">
          Dedicated to shaping a brighter future through education, mentorship, and unwavering integrity.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="p-10 bg-white rounded-xl shadow-xl hover:shadow-2xl transition transform hover:-translate-y-3 flex flex-col items-center text-center">
            ...
            <p className="text-gray-700 mt-4 leading-relaxed">
              Our mission is to empower students with <strong>knowledge</strong>, <strong>skills</strong>, and <strong>confidence</strong> 
              to excel in their academic and professional careers. We aim to create an environment where learning is interactive, 
              engaging, and tailored to individual needs. Through expert mentorship, we nurture future leaders who are not only 
              academically strong but also critical thinkers, problem solvers, and innovators in their fields.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition transform hover:-translate-y-2 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  We uphold honesty and transparency in everything we do, ensuring trust and respect in our relationships.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition transform hover:-translate-y-2 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  We embrace creativity and adapt to modern teaching methods to provide the best learning experience.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition transform hover:-translate-y-2 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  We are dedicated to providing top-quality education, ensuring student success at every level.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition transform hover:-translate-y-2 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  We strive for the highest standards in teaching and learning, pushing students towards success.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 mt-4">
            A journey of excellence, innovation, and transformation in education.
          </p>
        </div>
     ...
     <div className="py-20 bg-gradient-to-b from-blue-50 to-white mt-[4rem]">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-lg text-gray-600 mb-12">
          Empowering students with the best teaching methods to achieve academic success.
        </p>
