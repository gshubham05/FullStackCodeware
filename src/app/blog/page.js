          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-white/10 p-6 rounded-xl">
                ...
                <p className="opacity-90">Hiring Partners</p>
              </div>
            </div>

            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <button className="bg-white text-blue-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-transform transform hover:scale-105">
                Download Brochure
              </button>
              <button className="border-2 border-white px-8 py-3 rounded-lg hover:bg-white hover:text-blue-900 transition">
